...
public class Constants {
    ...
    public final static String FIB_X_AUTH = "FIB-X-AUTH";
    public final static List<Integer> denominationsBGN = Arrays.asList(5, 10, 20, 50, 100);
    public final static List<Integer> denominationsEUR = Arrays.asList(5, 10, 20, 50, 100, 200, 500);
